"""HenrikSpa: These tests should work with both QT5 and QT6."""
...
class TestGroupStats(object):
    ...
    def test_all_unique(self):
        _fields = [QgsField('id', QMetaType.Type.Int, str(QMetaType.Type.Int)),
                   QgsField('rows', QMetaType.Type.QString, str(QMetaType.Type.QString)),
                   QgsField('cols', QMetaType.Type.QString, str(QMetaType.Type.QString)),
                   QgsField('values', QMetaType.Type.Double, str(QMetaType.Type.Double))]
